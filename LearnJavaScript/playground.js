...
function convertToInteger(str) {
  return parseInt(str,2); // it knows it is a binary number by ,2!
}
...
// return num > 0 ? "positive" : num < 0 ? "negative" : "zero" I <3 Ternary operator!
...
console.log(myConcat([1,2],[3,4,5])); //arrow function!


const realNumberArray = [4,5.6,-9.8,42,6];
...
console.log(squaredIntegers); //HARD
...
const arr1 = ["a","b","c"];
let arr2;
arr2 = [...arr1]; // NOW THAT COPIES IT ... spread [...arrayName] spread operator
arr1[0] = "potato";
console.log(arr2);
...
const createPersonAdvanced = (fName, age, gender) => ({fName, age, gender})
console.log(createPersonAdvanced("a",31,"male"));
